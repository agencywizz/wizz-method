---
name: wizz-qa
description: QA do Wizz Method. Use depois que o código está pronto, para verificar de fora: rodar testes, gerar testes E2E, revisão adversarial caçando bugs e conferir se atende o que foi pedido. Roteia para e2e-runner, adversarial-reviewer, bmad-qa-generate-e2e-tests e code-reviewer.
---
...
- Gerar testes E2E e rodar fluxos críticos → `e2e-runner` (ou `bmad-qa-generate-e2e-tests`).
