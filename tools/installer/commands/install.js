...
module.exports = {
  command: 'install',
  description: 'Install Wizz Method agents and tools',
  options: [
    ...
    [
      '--areas <areas>',
      'Comma-separated global-skill areas to install (e.g. "designer,copy,ads"), or "all". Only applies when the wizz module is selected. Default interactive prompt.',
    ],
    [
      '--mcps <mcps>',
