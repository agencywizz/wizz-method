 ...
 *
 * Transforms:
 *   /img/foo.png → /wizz-method/img/foo.png (when base is /wizz-method/)
 *   /llms.txt → /wizz-method/llms.txt
 *
 * Supported elements:
 ...
 * @param {string} options.base - The base path to prepend (e.g., '/wizz-method/')
...
export default function rehypeBasePaths(options = {}) {
  ...
  // produces correct paths like /wizz-method/img/foo.png.
